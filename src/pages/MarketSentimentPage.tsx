  ...
  return (
    <main className="container mx-auto xl:w-[70%] pt-12 px-4 xl:px-0">
      ...
      <p className="text-lg text-[#07153B] dark:text-gray-300 mb-8">
        Get a pulse on the global crypto market in real time. McCoin’s Market Sentiment dashboard
        aggregates live data from trusted sources to help you gauge whether the market leans bullish
        or bearish.
      </p>
      ...
      <div className="mt-12 text-[#07153B] dark:text-white">
        ...
        <div className="text-[#07153B] dark:text-white pt-4">
          <p>
            The information displayed on this page is provided for general informational purposes
            only and does not constitute investment advice, financial advice, or trading
            recommendations.
          </p>
          <p>
            Market sentiment indicators are derived from external data sources and automated
            analysis, which may not always reflect real-time accuracy or completenes
          </p>
          <p>
            Please do your own research and consult a licensed financial advisor before making any
            investment decisions. Trading cryptocurrencies involves high risk and may result in
