...
const Hero = () => {
  return (
    <section>
      <h1 className="text-[#07153b] dark:text-white lg:text-3xl text-lg font-semibold tracking-wider lg:text-left text-center">
        Spot Market Overview
      </h1>
      <p className=" text-[#07153b]/80 dark:text-gray-400 mt-4 lg:text-[1rem] lg:text-base lg:text-left text-center lg:max-w-6xl">
