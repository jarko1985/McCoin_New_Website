...
export default function PartnerSwiper() {
 ...
 <div className="absolute inset-0 flex">
        ...
        <div className="w-1/4 h-full bg-gradient-to-r from-[#07153b] via-[#07153b]/80 to-transparent z-10 pointer-events-none" />
        <div className="flex-1" />
        <div className="w-1/4 h-full bg-gradient-to-l from-[#07153b] via-[#07153b]/80 to-transparent z-10 pointer-events-none" />
      </div>
