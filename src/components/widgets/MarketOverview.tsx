        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          {BtcArticles.map(article => (
            <motion.div
              ...
              className="bg-[#DAE6EA] dark:bg-[#07153b] backdrop-blur-md rounded-lg p-3 flex gap-4 items-center shadow-xl group border border-slate-400"
            >
              <Link
                href={article.URL || '#'}
              ...
              >
                ...
                <div className="flex-1 space-y-2">
                  <h4 className="text-[#07153b] dark:text-white font-semibold text-sm leading-snug group-hover:text-[#EC3B3B] transition-colors line-clamp-2">
                    {article.TITLE || 'Untitled Article'}
                  </h4>
                  <span className="p-[5px] rounded-xl text-xs bg-yellow-300 text-blue-950">
                    {article.AUTHORS || 'unknown Author'}
                  </span>
                  <div className="text-xs text-[#07153b] dark:text-[#DAE6EA] mt-1">
