...
const TradeNow = () => {
  return (
    <section className="relative dark:bg-[#050E27] bg-[#DAE6EA] border border-[#050E27] rounded-2xl overflow-hidden flex flex-col lg:flex-row items-center justify-between xl:max-w-[70%] mx-auto px-6 lg:px-12 py-12 gap-8 my-12">
