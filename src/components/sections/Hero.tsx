...
export default function HeroSection() {
  return (
    <section className="relative w-full h-[100vh] overflow-hidden bg-[#07153b]">
      <video
      ...
      <div className="container relative z-20 mx-auto flex flex-col items-center py-16 px-4">
        <div className="flex flex-col space-y-12 xl:pt-8 w-full">
          <h1 className="text-4xl lg:text-5xl text-center font-bold leading-tight text-[#DAE6EA]">
            Invest in <span className="text-[#EC3B3B]">McCoin</span>
            Way to Trade
          </h1>

          <p className="text-xl md:text-2xl text-[#DAE6EA]/80 text-center">
