      ...
      <div className="mx-auto xl:max-w-[70%]">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {values.map((value, index) => (
            ...
            >
              <Card className="bg-transparent shadow-2xl! borer-2 hover:border-slate-500 dark:border-white/20 dark:hover:border-white transition-all duration-300 h-full group">
