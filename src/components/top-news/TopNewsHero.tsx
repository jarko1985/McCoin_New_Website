        ...
        <>
          ...
          <AnimatePresence mode="wait">
            <motion.div
              ...
              style={{
                backgroundImage: `url(${
                  articles[activeIndex]?.image || '/images/fallback-image.jpeg'
                })`,
              }}
            />
          </AnimatePresence>
            ...
            <div className="lg:block hidden absolute right-0 bottom-0 md:right-8 md:bottom-auto md:top-1/2 md:transform md:-translate-y-1/2 w-full md:w-[25%] px-4 md:px-0 py-3 md:py-0">
              ...
              >
                {articles.map((article, index) => (
                  <SwiperSlide key={index} style={{ width: isMobile ? '75%' : '100%' }}>
                    <Link href={`/${locale}/top-news/${article.id}?source=gnews`}>
                      <motion.div
