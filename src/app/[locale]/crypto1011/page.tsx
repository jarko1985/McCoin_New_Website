...
export default function Crypto101Page() {
  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-[#07153b] to-[#0a1a4a] text-[#DAE6EA]">
      {/* Sidebar */}
      <motion.aside
        initial={{ x: -20, opacity: 0 }}
        animate={{ x: 0, opacity: 1 }}
        transition={{ duration: 0.5 }}
        className="w-[280px] border-r border-[#1a2d6b] flex flex-col bg-[#0a1a4a]/50 backdrop-blur-sm"
      >
      ...
      <main className="flex-1 p-6 md:px-10 overflow-auto xl:max-w-[65%]">
        <AnimatePresence mode="wait">
          ...
          >
            <motion.h1
              className="text-3xl md:text-4xl font-bold mb-6 bg-[#DAE6EA] bg-clip-text text-transparent"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
