    ...
    <div className="min-h-screen bg-[#07153B]">
      ...
      <section className="relative h-[600px] overflow-hidden">
        ...
        <div className="absolute inset-0 z-5">
          ...
          <div className="absolute top-40 right-40 w-12 h-12 bg-[#DAE6EA]/20 rounded-full animate-float opacity-60" style={{ animationDelay: '1s' }} />
        ...
        <div className="container mx-auto px-6">
          ...
          {filteredPosts.length === 0 && (
            <div className="text-center py-16 slide-in-up">
              ...
              <p className="text-[#DAE6EA]/50 text-sm mt-2">Try selecting a different category or check back later.</p>
            </div>
          )}
        </div>
      </section>
      ...
      <section className="py-20 bg-gradient-to-r from-[#07153B] to-[#EC3B3B]/20 relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute bottom-20 right-20 w-24 h-24 bg-[#DAE6EA]/10 rounded-full animate-float" style={{ animationDelay: '2s' }} />
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-40 h-40 bg-gradient-to-r from-[#EC3B3B]/5 to-[#DAE6EA]/5 rounded-full animate-float" style={{ animationDelay: '1s' }} />
        </div>
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative fade-in-scale">
              ...
              <div className="absolute -bottom-4 -left-4 w-16 h-16 bg-[#DAE6EA] rounded-full opacity-20 animate-float glow-effect" style={{ animationDelay: '1s' }} />
            </div>
            ...
            <div className="space-y-8 slide-in-up">
              ...
              <div className="flex flex-wrap items-center gap-6 text-[#DAE6EA]/70">
                <div className="flex items-center group">
                  ...
                  <span className="text-sm group-hover:text-[#EC3B3B] transition-colors duration-300">Expert Insights</span>
                </div>
                <div className="flex items-center group">
