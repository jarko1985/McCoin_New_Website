  ...
  const emailContent = `
    ...
    <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
      <div style="background: linear-gradient(135deg, #07153B 0%, #1A0A2E 100%); padding: 30px; border-radius: 10px; text-align: center;">
        ...
        <h1 style="color: #ffffff; margin-bottom: 20px;">Welcome to McCoin!</h1>
        <p style="color: #DAE6EA; font-size: 16px; margin-bottom: 30px;">
        ...
        <p style="color: #8CA3D5; font-size: 14px; margin-top: 30px;">
          If the button doesn't work, copy and paste this link into your browser:
        </p>
        <p style="color: #EC3B3B; font-size: 14px; word-break: break-all;">
          ${verifyUrl}
        </p>
        <p style="color: #8CA3D5; font-size: 12px; margin-top: 30px;">
